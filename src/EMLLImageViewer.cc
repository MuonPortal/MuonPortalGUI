...
EMLLImageViewer::EMLLImageViewer(const TGWindow *p,UInt_t w,UInt_t h,std::string filename)
  ...
  xyOptionFrame->AddFrame(optionButtonXY, new TGLayoutHints(kLHintsCenterY | kLHintsCenterX | kLHintsTop,2,2,2,2));
	...
	fSliderXY->Connect("PositionChanged(Int_t)","EMLLImageViewer",this,"SlideXY(Int_t)");
	...
	modifyXYTomographyButton->Connect("Clicked()","EMLLImageViewer",this,"ModifyXY()");
	...
	fThresholdNumEntryXY->Connect("ValueSet(Long_t)", "EMLLImageViewer", this, "ApplyThresholdXY()");
	(fThresholdNumEntryXY->GetNumberEntry())->Connect("ReturnPressed()", "EMLLImageViewer", this,"ApplyThresholdXY()");
	...
	fEventThresholdNumEntryXY->Connect("ValueSet(Long_t)", "EMLLImageViewer", this, "ApplyThresholdXY()");
	(fEventThresholdNumEntryXY->GetNumberEntry())->Connect("ReturnPressed()", "EMLLImageViewer", this,"ApplyThresholdXY()");
  ...
  xzOptionFrame->AddFrame(optionButtonXZ, new TGLayoutHints(kLHintsCenterY | kLHintsCenterX | kLHintsTop,2,2,2,2));
	...
	fSliderXZ->Connect("PositionChanged(Int_t)","EMLLImageViewer",this,"SlideXZ(Int_t)");
	...
	modifyXZTomographyButton->Connect("Clicked()","EMLLImageViewer",this,"ModifyXZ()");
	...
	fThresholdNumEntryXZ->Connect("ValueSet(Long_t)", "EMLLImageViewer", this, "ApplyThresholdXZ()");
	(fThresholdNumEntryXZ->GetNumberEntry())->Connect("ReturnPressed()", "EMLLImageViewer", this,"ApplyThresholdXZ()");
	...
	fEventThresholdNumEntryXZ->Connect("ValueSet(Long_t)", "EMLLImageViewer", this, "ApplyThresholdXZ()");
	(fEventThresholdNumEntryXZ->GetNumberEntry())->Connect("ReturnPressed()", "EMLLImageViewer", this,"ApplyThresholdXZ()");
  ...
  yzOptionFrame->AddFrame(optionButtonYZ, new TGLayoutHints(kLHintsCenterY | kLHintsCenterX | kLHintsTop,2,2,2,2));
	...
	fSliderYZ->Connect("PositionChanged(Int_t)","EMLLImageViewer",this,"SlideYZ(Int_t)");
	...
	modifyYZTomographyButton->Connect("Clicked()","EMLLImageViewer",this,"ModifyYZ()");
	...
	fThresholdNumEntryYZ->Connect("ValueSet(Long_t)", "EMLLImageViewer", this, "ApplyThresholdYZ()");
	(fThresholdNumEntryYZ->GetNumberEntry())->Connect("ReturnPressed()", "EMLLImageViewer", this,"ApplyThresholdYZ()");
	...
	fEventThresholdNumEntryYZ->Connect("ValueSet(Long_t)", "EMLLImageViewer", this, "ApplyThresholdYZ()");
	(fEventThresholdNumEntryYZ->GetNumberEntry())->Connect("ReturnPressed()", "EMLLImageViewer", this,"ApplyThresholdYZ()");
	...
	//fDoubleSliderXYZ->Connect("PointerPositionChanged()", "EMLLImageViewer",this,"DoubleSlideXYZ()");
  fDoubleSliderXYZ->Connect("PositionChanged()", "EMLLImageViewer",this,"DoubleSlideXYZ()");
	...
	fDoubleSliderMinTextXYZ->Connect("TextChanged(char*)", "EMLLImageViewer",this,"DoubleSlideXYZText(char*)");
	...
	fDoubleSliderMaxTextXYZ->Connect("TextChanged(char*)", "EMLLImageViewer",this,"DoubleSlideXYZText(char*)");
  ...
  volRendTomographySliderFrame->AddFrame(sliderButton3D, new TGLayoutHints(kLHintsCenterX | kLHintsTop,2,2,2,2));
	...
	fSlider3D->Connect("PositionChanged(Int_t)","EMLLImageViewer",this,"Slide3D(Int_t)");
	...
	modify3DTomographyButton->Connect("Clicked()","EMLLImageViewer",this,"Modify3D()");
...
EMLLImageViewer::~EMLLImageViewer(){
...
void EMLLImageViewer::Init(){

	cout<<"EMLLImageViewer::Init() ..."<<endl;
	for(int i=0;i<MAXNIMAGES;i++){
		
		TString imageName= Form("EMLLImageXY%d",i+1);
		...
		imageName= Form("EMLLImageXZ%d",i+1);
		...
		imageName= Form("EMLLImageYZ%d",i+1);
		...
		imageName= Form("EMLLImage3D%d",i+1);
...
void EMLLImageViewer::ReadData(){

	cout<<"EMLLImageViewer::ReadData()"<<endl;
	isFileReadCall= true;
	fNImageXY= 0;
	fNImageXZ= 0;	
	fNImageYZ= 0;
	...
	if(!currentPalette){
		cerr<<"EMLLImageViewer::ReadData(): ERROR: Cannot open file "<<fInputFileName.c_str()<<" to read...exit!"<<endl;
	...
	if(fNImageXY<=0 || fNImageXZ<=0 || fNImageYZ<=0 || fNImage3D<=0){
		cerr<<"EMLLImageViewer::ReadData(): ERROR: No images to draw...exit!";
		gApplication->Terminate();
	}
	else{
		cout<<"EMLLImageViewer::ReadData(): INFO: (Nxy,Nxz,Nyz,N3D)=("<<fNImageXY<<","<<fNImageXZ<<","<<fNImageYZ<<","<<fNImage3D<<") images read..."<<endl;
		...
		if(!currentImageXY){
			cerr<<"EMLLImageViewer::ReadData(): ERROR: Cannot read current image XY...exit!";
			gApplication->Terminate();
		}
		if(!currentImageXZ){
			cerr<<"EMLLImageViewer::ReadData(): ERROR: Cannot read current image XZ...exit!";
			gApplication->Terminate();
		}
		if(!currentImageYZ){
			cerr<<"EMLLImageViewer::ReadData(): ERROR: Cannot read current image YZ...exit!";
			gApplication->Terminate();
		}
		if(!currentImage3D){
			cerr<<"EMLLImageViewer::ReadData(): ERROR: Cannot read current image YZ...exit!";
...
void EMLLImageViewer::DrawXY(){
	
	
	TCanvas* canvas = fXYTomographyCanvas->GetCanvas();
	if(!canvas){
		cerr<<"EMLLImageViewer::DrawXY(): ERROR: Cannot read current canvas...exit!";
		gApplication->Terminate();
	}
	canvas->cd();
...
}//close EMLLImageViewer::DrawXY()

void EMLLImageViewer::DrawXZ(){
	
	TCanvas* canvas = fXZTomographyCanvas->GetCanvas();
	if(!canvas){
		cerr<<"EMLLImageViewer::DrawXZ(): ERROR: Cannot read current canvas...exit!";
		gApplication->Terminate();
	}
	canvas->cd();
	canvas->SetEditable(true);
...
}//close EMLLImageViewer::DrawYZ()


void EMLLImageViewer::Draw3D(){
	
	TCanvas* canvas = f3DTomographyCanvas->GetCanvas();
	if(!canvas){
		cerr<<"EMLLImageViewer::Draw3D(): ERROR: Cannot read current canvas...exit!";
		gApplication->Terminate();
	}
	canvas->cd();
	canvas->SetEditable(true);	
...
}//close EMLLImageViewer::Draw3D()


void EMLLImageViewer::DrawXYZ(){

	TCanvas* canvas = fXYZTomographyCanvas->GetCanvas();
	if(!canvas){
		cerr<<"EMLLImageViewer::DrawXYZ(): ERROR: Cannot read current canvas...exit!";
		gApplication->Terminate();
	}
	canvas->cd();
	canvas->SetEditable(true);
...
}//close EMLLImageViewer::DrawXYZ()


void EMLLImageViewer::ModifyXY(){

	currentImageXY->StartPaletteEditor();
	
}//close EMLLImageViewer::ModifyXY()


void EMLLImageViewer::ModifyXZ(){

	currentImageXZ->StartPaletteEditor();
	
}//close EMLLImageViewer::ModifyXZ()

void EMLLImageViewer::ModifyYZ(){

	currentImageYZ->StartPaletteEditor();
	
}//close EMLLImageViewer::ModifyYZ()

void EMLLImageViewer::Modify3D(){

	currentImage3D->StartPaletteEditor();
	
}//close EMLLImageViewer::Modify3D()


void EMLLImageViewer::SlideXY(int pos){
...
}//close EMLLImageViewer::SlideXY()

void EMLLImageViewer::SlideXZ(int pos){
...
}//close EMLLImageViewer::SlideXZ()

void EMLLImageViewer::SlideYZ(int pos){
...
}//close EMLLImageViewer::SlideYZ()




void EMLLImageViewer::DoubleSlideXYZText(char*){
...
void EMLLImageViewer::DoubleSlideXYZ(){
...
}//close EMLLImageViewer::DoubleSlideXYZ()

void EMLLImageViewer::Slide3D(int pos){
...
}//close EMLLImageViewer::Slide3D()


void EMLLImageViewer::ApplyThresholdXY(){
...
void EMLLImageViewer::ApplyThresholdXZ(){
...
void EMLLImageViewer::ApplyThresholdYZ(){
...
void EMLLImageViewer::SetGraphicsStyle(){
