...
##Xvfb -reset :1 -screen 0 1024x768x8 &
#Xvfb :1 -screen 0 1024x768x8 &
#export DISPLAY=":1"

VisIVOViewer --volume --backcolor black --vrendering --vrenderingfield S --showbox --showaxes --showlut --cycle scripts/xyrotation --color --colortable scripts/paletteVisIVO2.dat --out $OUTPUTDATADIR/$IMGFILENAME_VREND $OUTFILENAME
